...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Penyelenggaraan | Gerbang Pembayaran Negeri Perlis</title>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-6">
                                            <div class="home-title mo-mb-20">
                                                <h1 class="mb-4 text-white">Penyelenggaraan</h1>
                                                <p class="text-white home-desc mb-5">Laman pembayaran dalam proses penyelenggaraan sehingga diberitahu kelak.</p>
                                                <a href="https://ebayar.perlis.gov.my" class="btn btn-primary">Kembali ke laman utama</a>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="home-img position-relative">
                                                <img src="images/clients/online-payment.png" alt="" class="home-first-img">
                                            </div>
                                        </div>
                                    </div>
                                </div>
